...
path=$(find ~/Library/Developer/Xcode/DerivedData/MyApp-*/Build/Products/Debug-iphonesimulator -name "MyApp.app" | head -n 1)
echo "${path}"
...
xcrun simctl launch "$line" com.myapp # Launch .app using its bundle at simulator with identifier hold by $line var
done
